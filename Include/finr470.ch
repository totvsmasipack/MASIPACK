	...
	#define STR0044 "Se considera para compner el Saldo inicial. 1- Sucursal: mov. bancarios de la sucursal; 2- Banco: todos los mov. del banco que se selecciono."
	#define STR0045 "Seleccione si el saldo sera compuesto "
	#define STR0046 "por el movimiento bancario de la sucusal "
	#define STR0047 "O por el movimiento total del banco que se selecciono "
#else
	#ifdef ENGLISH
		...
		#define STR0039 "  IN  "
		#define STR0040 " and "
		#define STR0041 "Start balance for?"
		#define STR0042 "Branch"
		#define STR0043 "Bank"
		#define STR0044 "Considered to be part of the Start Balance. 1- Branch: bank trans. from branch; 2- Bank: all transactions from selected Bank."
		#define STR0045 "Select whether balance is compounded "
		#define STR0046 "by branch bank transaction "
		#define STR0047 "Or by total transaction of selected bank "
	#else
