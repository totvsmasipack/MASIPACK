	...
	#define STR0006 "Codigo-SC-Nombre Cliente    Prf-Numero         TP  Modalidad  Fecha de   Vencto     Vencto    |Banco|Valor Original|       Titulos Vencidos        |Tit. por Vencer | Nr.Tit|      Vlr.Interes   Dias   Historial"
	#define STR0007 "                            Cuota                             Emision    Titulo     Real      |     |              | Valor Nominal  Valor Corregido|  Valor Nominal | no Bco|      Permanencia  Atraso           "
	...
	#define STR0055 " Sucursal - "
		...
		#define STR0006 "Code  -UN-Name of Customer  Prf-Number         Ty  Nature     Date of    Due Date   Real      |Bank| Original Value|        Bills   Due            |Bill to Maturing|N.Bill|     Value Interest    Days   History"
		...
		#define STR0006 "Codigo-Lj-Nome do Cliente   Prf-Numero         TP  NAT       Data de     Vencto     Vencto     Bco      Valor Original|         Titulos Vencidos        |Titulos a Vencer |       Vlr.juros ou  Dias   Historico     "
		#define STR0007 "                            Parcela                          Emissao     Titulo     Real                              | Valor Nominal  Valor Corrigido  |  Valor Nominal  |       permanencia  Atraso                "
		#define STR0008 "Por Cliente"
